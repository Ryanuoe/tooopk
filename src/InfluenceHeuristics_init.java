...
public class InfluenceHeuristics_init {
	 ...
	 //initialize
	 public InfluenceHeuristics_init(int sizeOfSeedSet) {
		super();
		//read hep
    ...
    //IC Model
	 public static void main(String args[])
     {
		 ...
		 for(int i=0; i<reps; i++){
		 	...
		 	System.out.println("--------------------------------------");
		 	InfluenceHeuristics_init g = new InfluenceHeuristics_init(10);// init sizeOfSeedSet 30
		 	g.run();
